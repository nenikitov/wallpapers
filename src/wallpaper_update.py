...
if mode == '-h' or mode == '--help':
    ...
    print('  wallpaper_update')
    print('  wallpaper_update MODE')
    print('Regenerate README from csv file. Also can tag and save images.')
    print('')
    print('Modes:')
    print('  -h, --help')
    print('     Display this help message and exit')
    print('  -b, --both')
    print('     Regenerate README, tag and save images (Default mode)')
    print('  -r, --readme')
...
if save_readme:
    readme('# Note')
    readme('')
    readme('The vast majority of these wallpapers are taken from random web-sites all over the internet and other repositories with wallpapers, I did not create them.')
    ...
    readme('# Usage')
    readme('')
    readme(f'You can use the files in the `{img_source_name}/` folder as they are.')
    readme('')
    readme(f'However, if you want to have the images to be tagged, use the script included in the `src/` directory. The tagged files will end up in `{img_tag_name}/` directory.')
    readme('```bash')
    readme('# (These instructions assume that the current working directory is the root of the repo)')
    readme('')
    readme('# Ensure that all python modules are installed')
    readme('pip install -r requirements.txt')
    readme('# Run the script itself')
    readme('#   No options if you want both the README and the tagged images folder to be updated')
    readme('#   Add "-r" option if you only want to regenerate the `README.md`')
    readme('#   Add "-t" option if you only want to tag and save images')
    readme('#   Add "-h" option if you need more help running the script')
